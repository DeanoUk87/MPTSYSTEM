...
class BookingController extends BaseApiController
{
     ...
     */
    public function confirmCollection(Request $request, $job_ref): JsonResponse
    {
        try {
            $validated = $request->validate([
                'driver_collection_time' => 'nullable|date_format:H:i',
            ]);
            ...
            // Ensure the logged-in driver owns this job
            ...
            $booking->driver_collection_time = $validated['driver_collection_time'] ?? Carbon::now()->format('H:i');
            $booking->save();
    ...
    public function update(Request $request)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'pod_time' => 'required|date_format:H:i',
            ...
            if ($validated['type'] === 'delivery') {
                ...
                $booking->pod_time = $validated['pod_time'] ?? Carbon::now()->format('H:i');;
    ...
    public function updateVia(Request $request)
    {
        try {
            ...
            $via->time = $validated['pod_time'] ?? Carbon::now()->format('H:i');
