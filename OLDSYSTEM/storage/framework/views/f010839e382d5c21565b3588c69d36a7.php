<script>
    function initMap() {
        ...
        var ctaLayer = new google.maps.KmlLayer('<?php echo e(asset('ULEZone2.kml')); ?>');
        ...
        document.getElementById('submit').addEventListener('click', function () {
            ...
            $.get('<?php echo e(route('booking.similar')); ?>?customer='+customerSimilar+'&address1='+addressSimilar1+'&address2='+addressSimilar2, function(data){
    ...
    function calculateAndDisplayRoute(directionsService, directionsDisplay) {
        ...
        <?php if(isset($booking) && $booking->delivery_address1): ?>
        <?php if(count($addresses)>0): ?>
        <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        waypts.push({
            location: "<?php echo e($value->postcode); ?>, <?php echo e($value->address1); ?> <?php echo e($value->address2); ?> <?php echo e($value->area); ?> <?php echo e($value->country); ?>",
            stopover: true
        });
        ...
        <?php if(isset($booking)): ?>
        var bookingOrigin = "<?php echo e($booking->collection_postcode); ?> <?php echo e($booking->collection_address1); ?> <?php echo e($booking->collection_address2); ?> <?php echo e($booking->collection_area); ?> <?php echo e($booking->collection_country); ?>";
        var bookingDestination = "<?php echo e($booking->delivery_postcode); ?> <?php echo e($booking->delivery_address1); ?> <?php echo e($booking->delivery_address2); ?> <?php echo e($booking->delivery_area); ?> <?php echo e($booking->delivery_country); ?>";
        <?php endif; ?>
        ...
        directionsService.route({
            ...
            if (status === 'OK' && response.routes && response.routes.length > 0) {
                ...
                <?php if(isset($booking)): ?>
                document.getElementById('miles').value='<?php echo e(round($booking->miles)); ?>';
                <?php if($booking->manual_amount>0): ?>
                document.getElementById('cost').value='<?php echo e($booking->manual_amount); ?>';
                document.getElementById('profit').value='<?php echo e($booking->manual_amount); ?>';
                <?php else: ?>
                document.getElementById('cost').value='<?php echo e($booking->cost); ?>';
                document.getElementById('profit').value='<?php echo e($booking->cost-$booking->driver_cost-$booking->extra_cost); ?>';
                <?php endif; ?>
                <?php endif; ?>
                ...
                <?php if(isset($booking) && $booking->avoid_tolls): ?>
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google.api_key')); ?>&callback=initMap&libraries=places&sensor=false">
</script>
<?php /**PATH /home/mptportco/public_html/portal.mp-transport.co.uk/resources/views/partials/googleDirection.blade.php ENDPATH**/ ?>