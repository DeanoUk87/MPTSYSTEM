<script type="text/javascript">
  ...
  function editForm(url,id) {
    $(".content-loader").fadeOut('slow', function()
    {
      ...
      $.getScript("<?php echo e(asset('templates/admin/assets/js/custom.js')); ?>");
...
<?php /**PATH /home/mptportco/public_html/portal.mp-transport.co.uk/resources/views/partials/customjs.blade.php ENDPATH**/ ?>