                            ...
                            <li class="clearfix">
                                <a class="media-box" href="#">
                                    ...
                                    <span class="pull-left">
                                        <img alt="user" class="media-box-object rounded-circle" src="<?php echo e(asset('templates/admin/images/avatar.jpg')); ?>" style="width: 50px;">
                                    </span>
...
</nav><?php /**PATH /home/mptportco/public_html/portal.mp-transport.co.uk/resources/views/partials/nav-right.blade.php ENDPATH**/ ?>