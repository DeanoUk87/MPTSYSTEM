<script type="text/javascript">
  ...
  $('#driverCost').on('change',function(){
    ...
    // Only overwrite a manually-entered cost if the driver has a per-mile rate configured
    if (driverPerMiles > 0) {
    ...
    if(valArray[1])
    /*Driver Contact*/
    $.get('<?php echo e(route('booking.driver.contact')); ?>?driverMain='+valArray[1]+'&jobId=<?php if(isset($booking)): ?><?php echo e($booking->job_ref); ?><?php endif; ?>', function(data){
  ...
  $('#driverCost2').on('change',function(){
    ...
    if(valArray2[1])
    /* Driver Contact */
    $.get('<?php echo e(route('booking.driver.contact')); ?>?driver='+valArray2[1]+'&jobId=<?php if(isset($booking)): ?><?php echo e($booking->job_ref); ?><?php endif; ?>', function(data){
      $( "#driverContact" ).html( data );
    });
  });
  ...
  <?php if(isset($booking) && ($booking->driver || $booking->second_man)): ?>
  $.get('<?php echo e(route('booking.driver.contact')); ?>?driver=<?php echo e($booking->driver ?: $booking->second_man); ?>&jobId=<?php if($booking): ?><?php echo e($booking->job_ref); ?><?php endif; ?>', function(data){
    $( "#driverContact" ).html( data );
    <?php if($booking->driver): ?>
    var driverContactEl = document.getElementById('driverContact');
    if (driverContactEl) {
      driverContactEl.setAttribute('data-drivermain', '<?php echo e($booking->driver); ?>');
    }
    <?php endif; ?>
  });
  $.get('<?php echo e(route('booking.driver.info')); ?>?driver=<?php echo e($booking->driver_contact); ?>', function(data){
    $( "#driverContactInfo" ).html( data );
  });
  <?php endif; ?>


  <?php if(isset($booking) && $booking->driver_contact): ?>
  $.get('<?php echo e(route('booking.driver.contact')); ?>?subDriver=<?php echo e($booking->driver_contact); ?>&jobId=<?php if($booking): ?><?php echo e($booking->job_ref); ?><?php endif; ?>', function(data){
    $( "#unitStorage" ).html( data );
    var unitStorageEl = document.getElementById('unitStorage');
    if (unitStorageEl) {
      unitStorageEl.setAttribute('data-subdriver', '<?php echo e($booking->driver_contact); ?>');
    }
  });
  <?php endif; ?>
  ...
  function driverInfoSel() {
    ...
    $.get('<?php echo e(route('booking.driver.info')); ?>?driver='+thDriver, function(data){
      $( "#driverContactInfo" ).html( data );
    });
    $.get('<?php echo e(route('booking.driver.contact')); ?>?subDriver='+thDriver+'&jobId=<?php if(isset($booking)): ?><?php echo e($booking->job_ref); ?><?php endif; ?>', function(data){
      $( "#unitStorage" ).html( data );
  ...
  $('#jobTypeChange').on('change', function () {
      ...
      $.get('<?php echo e(route("customer.rates")); ?>?cust=' + custId + '&weekend=' + newWeekend + '&edit=1', function (data) {
  ...
  $.get('<?php echo e(route('customer.rates')); ?>?cust=<?php echo e(request()->input('cust')); ?>&weekend=<?php echo e($weekend); ?>', function(data){
    $( "#customerRates" ).html( data );
    vehicleCost();
  });
  ...
  <?php if(request()->input('edit') and $booking): ?>
  /*Get similar jobs*/
  ...
  $.get('<?php echo e(route('booking.similar',['jobId'=>$booking->job_ref])); ?>&customer='+customerSimilar+'&address1='+addressSimilar1+'&address2='+addressSimilar2+'&vehicle='+vehicleSimilar, function(data){
  ...
  var cc_object = new clickToAddress({
    accessToken: "<?php echo e(env('CRAFTY_CLICKS_API_KEY')); ?>",
    onResultSelected: function(c2a, elements, address){
      ...
      $.get('<?php echo e(route('viaaddress.name')); ?>?postcode='+address1+'&type=Collection', function(data){
        $('#collectionAutocomplete').val(data);
      });
      $.get('<?php echo e(route('viaaddress.name')); ?>?postcode='+address2+'&type=Delivery', function(data){
  ...
  cc_object.attach({
    search:		'search-<?php echo e($num); ?>',
    company:	'name-<?php echo e($num); ?>[]',
    town:		'area-<?php echo e($num); ?>[]',
    postcode:	'postcode-<?php echo e($num); ?>[]',
    county:		'state-<?php echo e($num); ?>[]',
    country:	'country-<?php echo e($num); ?>[]',
    line_1:		'address1-<?php echo e($num); ?>[]',
    line_2:		'address2-<?php echo e($num); ?>[]'
  });
    <?php endfor; ?>

</script>
<?php /**PATH /home/mptportco/public_html/portal.mp-transport.co.uk/resources/views/partials/bookingjs.blade.php ENDPATH**/ ?>