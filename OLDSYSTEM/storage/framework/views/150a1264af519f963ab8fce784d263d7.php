<script type="text/javascript">
  ...
  $("#customersAutocomplete1").autocomplete({
    ...
    source: function (request, response) {
      ...
      $.ajax({
        url: "<?php echo e(route('customers.address.auto')); ?>",//url
    ...
    select: function (even, ui) {
      if (document.getElementById('collection_address1') !== null) {
        $.getJSON('<?php echo e(route('customers.address.byid', ['id' => '__ID__'])); ?>'.replace('__ID__', ui.item.id), function (data) {
        ...
        window.location.href ='<?php echo e(route('booking.create')); ?>?cust='+ui.item.id;
      }
    }
  });
  ...
  $("#customersAutocomplete2").autocomplete({
    ...
    select: function (even, ui) {
      window.location.href ='<?php echo e(route('booking.index',['user'=>0])); ?>?fromdate=0&todate=0&customer'+ui.item.id+'&driver=0';
    }
  });
  ...
  $("#collectionAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('viaaddress.address')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
  ...
  $("#invoiceAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('invoices.auto')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
  ...
  $("#driverAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('driver.auto')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
  ...
  $("#vehicleAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('vehicle.auto')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
  ...
  $("#ratesAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('rates.auto')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
  ...
  $("#userAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('user.auto')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
  ...
  $("#nameAutocomplete-<?php echo e($num); ?>").autocomplete({
    minLength:2,
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
    ...
    select: function (even, ui) {
      $("#name-<?php echo e($num); ?>").val(ui.item.name);
      $("#address1-<?php echo e($num); ?>").val(ui.item.address1);
      $("#address2-<?php echo e($num); ?>").val(ui.item.address2);
      $("#area-<?php echo e($num); ?>").val(ui.item.area);
      $("#country-<?php echo e($num); ?>").val(ui.item.country);
      $("#postcode-<?php echo e($num); ?>").val(ui.item.postcode);
      $("#contact-<?php echo e($num); ?>").val(ui.item.contact);
      $("#phone-<?php echo e($num); ?>").val(ui.item.phone);
    }
  });
  <?php endfor; ?>
  ...
  $("#oldCustomersAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('oldCustomers.address.auto')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
  ...
  $("#oldDriverAutocomplete").autocomplete({
    ...
    source: function (request, response) {
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
        url: "<?php echo e(route('oldDriver.address.auto')); ?>",//url
        data: { searchText: request.term, '_token': csrf_token},
        dataType: "json",
        type: "POST",
        success: function (data) {
...
<?php /**PATH /home/mptportco/public_html/portal.mp-transport.co.uk/resources/views/partials/autocomplete.blade.php ENDPATH**/ ?>